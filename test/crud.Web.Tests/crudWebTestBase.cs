...
{
    public abstract class crudWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static crudWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(crudWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<crudDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<crudDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<crudDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<crudDbContext, Task<T>> func)
        {
            T result;
